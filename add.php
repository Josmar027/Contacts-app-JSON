...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $contacts[] = $contact; // Añadimos el contenido del array de POST al array nuevo

  file_put_contents("contacts.json", json_encode($contacts)); // Metemos los datos a un fichero json

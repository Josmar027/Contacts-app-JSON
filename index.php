<?php
// Nos traemos el JSON generado anteriormente. Lo decodificamos para sacar la informacion (nombre y tlf) y lo añadimos a la variable $contacts, luego la recorreremos y pintaremos los datos que son nombre y tlf.
